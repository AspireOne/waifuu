    ...
    <PublicPage title={"A.I. Gateway"} description={""}>
      ...
      <div className={"flex flex-col lg:flex-row gap-12 lg:gap-4"}>
        <div className={"w-full"}>
          <Title description={"V současnosti nejlepší A.I. na generování obrázků"}>
            DALL-E 3
          </Title>
          <p>
        ...
        <div className={"w-full"}>
          ...
          <p>
            - Nastavení je trošku cumbersome (ale i tak jen na 2 minutky) - kdyby tě to
            zajímalo, dáme to dohromady.
          </p>
        </div>
      </div>
      ...
      <div className={"flex flex-col lg:flex-row gap-12 lg:gap-4"}>
        ...
        <div className={"w-full"}>
          ...
          <p className={"whitespace-pre-wrap"}>
            ...
            <br />- image-to-image (úprava existující fotky jen na základě promptu)
            <br />- rozšíření fotky / obrázku
            <br />- generování variant, vytvoření animace z fotky, změna pozadí...
            <br />
            <br />
            <b>Videa:</b>
            <br />- video-to-video
