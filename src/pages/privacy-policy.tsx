  ...
  return (
    <PublicPage title={t`Privacy Policy`} description={"TODO desc"}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held
      ...
      <p>
        ...
        will only collect, store and process your personal data in accordance with GDPR
        requirements.
      </p>{" "}
      <p>
        We will obtain your consent before collecting any sensitive personal data such as
        health information, biometric data, genetic data, religious beliefs, political
        opinions, sexual orientation, etc. You have the right to withdraw this consent at any
        time.
      </p>{" "}
      <p>
        We will only collect and process the minimum amount of personal data needed to provide
        our services. We will not collect any personal data from you that we do not need.
      </p>{" "}
      <p>
        We will inform you of the purpose for collecting your personal data, how we use it, how
        long we retain it, and when and why we share it with third parties.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        also request rectification or erasure of your personal data. Please contact us using
        the information provided if you would like to exercise any of these GDPR rights.
      </p>{" "}
      <p>
        If we suffer a personal data breach, we will notify the appropriate supervisory
        authority within 72 hours after becoming aware of it, unless the breach is unlikely to
