...
export default () => {
  return (
    <Page title={t`Privacy Policy`}>
      ...
      <Title className={"my-3"}>Interpretation</Title>
      <p>
        The words of which the initial letter is capitalized have meanings defined under the
        following conditions. The following definitions shall have the same meaning regardless of
        whether they appear in singular or in plural.
      </p>
      <Title className={"my-3"}>Definitions</Title>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Companion, the software program provided by the
            Company.
          </p>
        </li>
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Companion.
          </p>
        </li>
        <li>
          <p>
      ...
      <Title className={"my-3"}>Types of Data Collected</Title>
      <Title className={"my-3"} size={"md"}>
        Personal Data
      </Title>
      <p>
      ...
      <Title className={"my-3"}>Use of Your Personal Data</Title>
      ...
      <Title className={"my-3"}>Retention of Your Personal Data</Title>
      <p>
      ...
      <Title className={"my-3"}>Transfer of Your Personal Data</Title>
      <p>
      ...
      <Title className={"my-3"}>Delete Your Personal Data</Title>
      <p>
      ...
      <Title className={"my-3"}>Disclosure of Your Personal Data</Title>
      <Title className={"my-3"} size={"md"}>
      ...
      <Title className={"my-3"}>GDPR Compliance</Title>{" "}
      <p>
        We are committed to compliance with the General Data Protection Regulation (GDPR) and will
        only collect, store and process your personal data in accordance with GDPR requirements.
      </p>{" "}
      <p>
        We will obtain your consent before collecting any sensitive personal data such as health
        information, biometric data, genetic data, religious beliefs, political opinions, sexual
        orientation, etc. You have the right to withdraw this consent at any time.
      </p>{" "}
      <p>
        We will only collect and process the minimum amount of personal data needed to provide our
        services. We will not collect any personal data from you that we do not need.
      </p>{" "}
      <p>
        We will inform you of the purpose for collecting your personal data, how we use it, how long
        we retain it, and when and why we share it with third parties.
      </p>{" "}
      <p>
        We will not share or sell your personal data with any third parties unless we have your
        explicit consent to do so.
      </p>{" "}
      <p>
        You have the right to request access to the personal data we hold about you. You can also
        request rectification or erasure of your personal data. Please contact us using the
        information provided if you would like to exercise any of these GDPR rights.
      </p>{" "}
      <p>
        If we suffer a personal data breach, we will notify the appropriate supervisory authority
        within 72 hours after becoming aware of it, unless the breach is unlikely to result in a
        risk to your rights and freedoms.
      </p>{" "}
      <p>
        We regularly review our compliance with GDPR and take reasonable steps to ensure your
        personal data is always properly protected and only used in accordance with GDPR
        requirements.
      </p>
      <Title className={"my-3"}>Security of Your Personal Data</Title>
      <p>
